...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 01, 2023 at 03:33 PM
...
(10, 'admin', 'admin', 'admin', '999999999', 1, 'admin', 1);
...
(6, 'aryan', '', 1, 'gdhgk', 'rhtgjhjgfd', '2023-01-24', '11:04 AM'),
(7, 'aryan', '', 1, 'gdhgk', 'rhtgjhjgfd', '2023-01-24', '11:06 AM'),
(8, 'aryan', '', 1, 'cxbgnfm', 'c cbnvm,z', '2023-01-24', '11:06 AM'),
(11, '4SF20IS007', '', 1, 'gdhgk', 'yttyuy', '2023-01-25', '07:46 AM'),
(13, 'Aditya Bhandary', '', 1, 'cxbgnfm', 'rdgt', '2023-01-25', '07:57 AM');
...
('4SF20IS007', 'Aditya', 'Bhandary', '7259648307', 'IS', '2023', '$2y$10$NU0H639XUk.7v1JadHMnge.Lmoo3ZpChn64XGVlTUZXKbn2bVUNia', NULL, NULL),
('4SF20IS017', 'Aryan', 'Adhikari', '9481726766', 'IS', '2023', '$2y$10$s4v6C/gSRXlE0bZtc6.P0u9V8BsazScbs.VBSTuZJ.FQ7wnJ5S3oO', NULL, NULL);
...
--
ALTER TABLE `hostel_manager`
  MODIFY `Hostel_man_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
...
--
ALTER TABLE `application`
  ADD CONSTRAINT `Application_ibfk_1` FOREIGN KEY (`Student_id`) REFERENCES `student` (`Student_id`) ON DELETE CASCADE,
  ADD CONSTRAINT `Application_ibfk_2` FOREIGN KEY (`Hostel_id`) REFERENCES `hostel` (`Hostel_id`) ON DELETE CASCADE;

--
-- Constraints for table `hostel_manager`
--
ALTER TABLE `hostel_manager`
  ADD CONSTRAINT `Hostel_Manager_ibfk_1` FOREIGN KEY (`Hostel_id`) REFERENCES `hostel` (`Hostel_id`) ON DELETE CASCADE;

--
-- Constraints for table `message`
--
ALTER TABLE `message`
  ADD CONSTRAINT `Message_ibfk_1` FOREIGN KEY (`hostel_id`) REFERENCES `hostel` (`Hostel_id`) ON DELETE CASCADE;
