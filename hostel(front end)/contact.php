	...
	<header>
		<div class="container agile-banner_nav">
			...
			<img src="web_home/images/logo.png" style="width:78px;height:78px;">
				...
				<h1><a class="navbar-brand" href="home.php">SCEM <span class="display"></span></a></h1>
				...
				<form action="contact.php" method="post">
					<div class="row">
						...
						<div class="col-md-6 contact_left_grid" data-aos="fade-left">
							...
							<input type="submit" name="submit" value="Submit" href=mailto:aryan.is20@sahyadri.edu.in>
					</div>
...
if(isset($_POST['submit'])){
	...
	$query = "INSERT INTO Message (sender_id,receiver_id,hostel_id,subject_h,message,msg_date,msg_time) VALUES ('$name','$hos_man_id','$hostel_id','$subject','$message','$today_date','$time')";
